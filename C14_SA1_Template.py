...
# Create a player object of class Player for player 2
# 1. Create "player2" object with properties - "Dodo", red_carx,red_cary
)
...
while carryOn:
    ...
    # Display the player 2 car image and name
    # 1. Display red car scaled to (80, 130) 

    # 2. Display player2 name at location (red_carx+20, red_cary+130)
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            # 1. If 'u' alphabet key is press move player2 upward, check for event "pygame.K_u"
            #    Call the method move_up() and store the result in red_cary 


                bgy -= 10
            # 2. If 'd' alphabet key is press move player2 downward, check for event "pygame.K_d"
            #    Call the method move_down() and store the result in red_cary 


                bgy += 10
            # 3. If 'r' alphabet key is press move player2 to the right, check for event "pygame.K_r"
            #    Call the method move_right() and store the result in red_carx


            # 4. If 'l' alphabet key is press move player2 to the left, check for event "pygame.K_l"
            #    Call the method move_left() and store the result in red_carx
